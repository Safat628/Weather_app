...
// Current city and  weather forecast after reload
...
//  API call and displays the current city, weather, and 5 day forecast 
...
async function displayWeather() {
  ...
  var uvIndexEl = $("<p class='card-text'>").text();
